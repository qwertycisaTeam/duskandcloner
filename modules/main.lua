...
function Module:Init(Library, Window, Tab)
    ...
    -- Адаптивный заголовок (Без жирного тега <b>, более элегантный шрифт)
    Library.Utils.Make("TextLabel", {
        Text = '<font color="#ffffff">UTILITY:</font> <font color="#9696a0">House Builder</font>',
        RichText = true, 
        Size = UDim2.new(1, -40, 1, 0), 
        Position = UDim2.new(0, 5, 0, 0),
        BackgroundTransparency = 1, 
        Font = Enum.Font.GothamMedium, -- Более чистый шрифт
        TextSize = 14, 
    ...
    -- Иконка стартует с цвета SubText (серая)
    ...
    -- Анимация наведения (Иконка красится в Accent-тему)
    ...
    -- ==========================================
    -- 3. ДРОПДАУН И ПОЛНАЯ СТИЛИЗАЦИЯ
    -- ==========================================
        ...
        for _, frame in ipairs(Tab.Page:GetChildren()) do
            if frame:IsA("Frame") and frame.Size == UDim2.new(1, 0, 0, 40) then 
                ...
                if btn then
                    ...
                    -- Добавляем плавную обводку при наведении
                ...
                -- 4. Сдвигаем список меню под новую кнопку
